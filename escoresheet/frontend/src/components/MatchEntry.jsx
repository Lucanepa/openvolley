...
export default function MatchEntry({ matchId, team, onBack, embedded = false }) {
  ...
  // Collect all sanctions for display in Section 2
  ...
  return (
    <div style={{
      ...
      {/* SECTION 1: TO Counter | Score & Sets | Sub Counter */}
      <div style={{
        display: 'grid',
      ...
      {/* SECTION 2: Half Court (60%) | Sanctions (40%) */}
      <div style={{
        display: 'flex',
        gap: '8px',
        flex: 1,
        ...
        {/* Left: Half Court - 60% width, square aspect ratio */}
        <div style={{
          width: '60%',
          aspectRatio: '1 / 1',
        ...
        <div style={{
          ...
          {allSanctionsForDisplay.length === 0 ? (
            ...
            allSanctionsForDisplay.map((s, idx) => (
              <div key={idx} style={{
                display: 'flex',
                alignItems: 'center',
                gap: '8px',
