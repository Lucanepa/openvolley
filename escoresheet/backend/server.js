    ...
    ;(async () => {
      try {
        ...
        const beachRoles = [
          ...
          { key: 'beach_bench_team1', label: 'Team 1 Bench', path: '/beach-bench?team=team1', color: '#10b981', icon: '1️⃣' },
          { key: 'beach_bench_team2', label: 'Team 2 Bench', path: '/beach-bench?team=team2', color: '#ef4444', icon: '2️⃣' },
          { key: 'beach_livescore', label: 'Livescore', path: '/beach-livescore', color: '#8b5cf6', icon: '📊' }
        ]
...
<body>
  ...
  <div class="footer">
    ...
    All devices must be on the same network.<br>
    Tip: Install as a PWA from your browser menu for a native-like experience.
  </div>
</body>
</html>`
...
║  Bench:     http://${primaryIP}:${PORT}/beach-bench
║  Livescore: http://${primaryIP}:${PORT}/beach-livescore
║
